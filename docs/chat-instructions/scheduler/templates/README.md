...
|------|------------------|------------------------|------------|
| [`testing-services.md`](./testing-services.md) | The 22 diagnostic/testing services + their pricing, descriptions, notes, concern_categories (post-2026-05-19 refactor: 15 → 22 active + 3 deprecated; warning-light routing got 6 net-new services) | `upload_testing_services_md` | [`edit-testing-services.md`](../edit-testing-services.md) |
...
| [`subcategory-service-map.md`](./subcategory-service-map.md) | **(2026-05-20)** Wide-table MD mapping each subcategory_slug → eligible `testing_service_keys[]`. Cardinality 1:N. When set, overrides the parent category's testing_services list for that subcategory. | `upload_subcategory_service_map_md` | [`edit-subcategory-service-map.md`](../edit-subcategory-service-map.md) |
| [`subcategory-descriptions.md`](./subcategory-descriptions.md) | **(2026-05-21)** Per-block MD with `## category/slug` headings + description + positive examples + negative examples + synonyms. Drives Stage-2 of the 3-stage diagnostic classifier (subcategory pick by rich label text). 105 active blocks. | `upload_subcategory_descriptions_md` | [`edit-subcategory-descriptions.md`](../edit-subcategory-descriptions.md) |
| [`question-required-facts.md`](./question-required-facts.md) | **(2026-05-21)** Wide-table MD mapping each `question_id` → required `ExtractedFacts` slot names (from 29 canonical keys). Drives Stage-3 of the classifier (deterministic question-gate). 729 active question rows; empty = safe over-ask. | `upload_question_required_facts_md` | [`edit-question-required-facts.md`](../edit-question-required-facts.md) |
