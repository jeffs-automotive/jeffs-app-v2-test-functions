...
```
Step 1: read_file({ path: "<templates folder>\appointment-default-limits.md" })
...
Step 4: upload_appointment_default_limits_md({
...
You append `appointment-default-limits.md` to that folder path.
