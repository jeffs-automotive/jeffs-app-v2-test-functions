...
```
Step 1: read_file({ path: "<templates folder>\subcategory-service-map.md" })
        → returns the full MD content as a string

Step 2: upload_subcategory_service_map_md({
...
Step 4: upload_subcategory_service_map_md({
...
You append `subcategory-service-map.md` to that folder path.
