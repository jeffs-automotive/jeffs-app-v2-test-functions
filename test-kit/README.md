...
| **tekmetric posted-status** | A posted/sales rollup counts **both** `repairOrderStatusId` 5 (Posted) AND 6 (A/R) | contract: `tekmetric/__tests__/client.contract.test.ts` + agent `tekmetric-posted-status-5-6` | A/R sales dropped (`c9f8f64`) |
