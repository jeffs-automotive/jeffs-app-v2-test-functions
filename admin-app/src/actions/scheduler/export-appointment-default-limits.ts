...
/**
 * exportAppointmentDefaultLimitsAction — fetch current state as MD.
...
export const exportAppointmentDefaultLimitsAction = wrapAdminAction(
  "exportAppointmentDefaultLimits",
  impl,
  { orchestratorTool: "export_appointment_default_limits_md" },
);
