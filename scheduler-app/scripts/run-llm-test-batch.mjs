...
const BATCH_LABEL = "llm-test-5-anthropic-sdk-2stage-052026";
...
async function main() {
  ...
  const lines = [];
  lines.push(`# LLM diagnostic test — batch 5 (Haiku 4.5, Anthropic SDK + native structured outputs, May 2026)`);
  lines.push("");
