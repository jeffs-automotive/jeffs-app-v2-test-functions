// Shared answer-option presets used across the concern categories.
// Extracted from canonical-concern-catalog.ts (file-size-refactor batch 1).
...
export const BETTER_WORSE_SAME = [
