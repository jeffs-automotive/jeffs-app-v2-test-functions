...
// Phase 10 (2026-05-15): canonical capacity math now lives in the wizard
// helper module so both /book (legacy) and /book-v2 share one implementation.
// Phase 16 deletes this file; the helper survives.
import { computeAvailableDates } from "@/lib/scheduler/wizard/availability";
