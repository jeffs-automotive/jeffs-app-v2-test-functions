...
// Sub-feature A (2026-07-02): the MD-upload/export/revert/audit/ops/
// single-record-edit admin tool imports were deleted with the admin tool
// block — the schedulerconfig webforms call the direct RPCs instead.
...
export function getSchedulerTools(args: SchedulerToolsArgs) {
  ...
  // ─── Admin tools — REMOVED (sub-feature A, 2026-07-02) ────────────────────
  //
  // The schedulerconfig webforms replaced the MD-upload/export/revert/audit/
  // ops/single-record-edit tool surface with direct Server Actions + RPCs
  // (docs/scheduler/config-webforms-comms-types-plan-2026-07-02.md §3;
