-- =====================================================================
-- Remaining concern category subcategory + question seed
-- =====================================================================
-- Created 2026-05-16. Companion to 20260516210000_scheduler_brakes_subcategory_seed.sql.
--
-- Seeds the 12 remaining concern categories (everything except brakes)
-- with subcategories + diagnostic questions from
-- docs/scheduler/concerns/{category}/{category}-concerns.md.
--
-- Totals per category:
--   electrical     —  7 subs,  49 questions
--   hvac           —  8 subs,  56 questions
--   leak           —  7 subs,  49 questions
--   noise          — 10 subs,  70 questions
--   other          —  6 subs,  42 questions
--   performance    —  9 subs,  63 questions
...
-- =====================================================================
-- 1. Subcategory inserts (all 12 categories)
-- =====================================================================
...
VALUES
  ...
  (7476, 'electrical', 'an_accessory_doesnt_work',                      'An Accessory Doesn''t Work (Window, Radio, Dome Light, etc.)', 5, TRUE),
  ...
  (7476, 'hvac', 'vents_dont_blow_strongly_weak_airflow',               'Vents Don''t Blow Strongly (Weak Airflow)',             4, TRUE),
  ...
  (7476, 'leak', 'clear_yellow_or_light_brown_brake_fluid',             'Clear, Yellow, or Light Brown Puddle (Brake Fluid — Safety Concern)', 4, TRUE),
  (7476, 'leak', 'clear_odorless_puddle_water_or_ac_condensation',      'Clear, Odorless Puddle (Likely Water / AC Condensation)', 5, TRUE),
  (7476, 'leak', 'thick_dark_brown_puddle_gear_or_differential_oil',    'Thick Dark Brown Puddle With Strong Smell (Gear / Differential Oil)', 6, TRUE),
  ...
  -- ── Other (6) ───────────────────────────────────────────────────────
  (7476, 'other', 'multiple_symptoms_not_sure_what_category',           'Multiple Symptoms / Not Sure What Category',            1, TRUE),
  ...
  (7476, 'other', 'safety_concern_dont_feel_safe_driving_it',           'Safety Concern — Don''t Feel Safe Driving It',          4, TRUE),
  (7476, 'other', 'general_checkup_or_pre_trip_inspection',             'General Check-Up or Pre-Trip Inspection',               5, TRUE),
  (7476, 'other', 'car_has_been_sitting_unused_for_a_long_time',        'Car Has Been Sitting Unused for a Long Time',           6, TRUE),
  ...
  -- ── Smell (8) ───────────────────────────────────────────────────────
  (7476, 'smell', 'sweet_smell_maple_syrup_antifreeze',                 'Sweet Smell (Maple Syrup / Antifreeze)',                1, TRUE),
  ...
  -- ── Tires (7) ───────────────────────────────────────────────────────
  (7476, 'tires', 'visible_damage_nail_screw_bulge_cut',                'Visible Damage (Nail / Screw / Bulge / Cut)',           1, TRUE),
  ...
  (7476, 'vibration', 'shaking_or_bouncing_over_bumps',                 'Shaking or Bouncing Over Bumps and Rough Roads',        5, TRUE),
  (7476, 'vibration', 'constant_vibration_that_doesnt_change_w_speed',  'Constant Vibration That Doesn''t Change With Speed',    6, TRUE),
...
-- =====================================================================
-- 2a. ELECTRICAL questions (7 subcategories, 49 questions)
-- =====================================================================
...
new_questions(slug, question_text, options_json, display_order) AS (
  ...
  ('wont_crank_just_clicks',
   ...
   '[{"label":"Single loud click","value":"single_click"},{"label":"Rapid clicking","value":"rapid_click"},{"label":"No sound at all","value":"silent"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('wont_crank_just_clicks',
   ...
   '[{"label":"Normal brightness","value":"normal"},{"label":"Go dim when starting","value":"dim"},{"label":"Don''t come on at all","value":"none"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('wont_crank_just_clicks',
   'Have you tried jumping the car, and if you did, did it start right up after the jump?',
   '[{"label":"Yes — started after jump","value":"jump_worked"},{"label":"Tried jump, didn''t help","value":"jump_failed"},{"label":"Haven''t tried","value":"not_tried"}]',
   3),
  ('wont_crank_just_clicks',
  ...
  ('wont_crank_just_clicks',
   ...
   '[{"label":"Once recently","value":"once"},{"label":"Several times","value":"several"},{"label":"No recent jumps","value":"none"},{"label":"Not sure","value":"unsure"}]',
   5),
  ('wont_crank_just_clicks',
  ...
  ('slow_crank_sluggish_start',
   ...
   '[{"label":"Worse in cold","value":"cold"},{"label":"Worse in hot","value":"hot"},{"label":"Same regardless","value":"same"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('slow_crank_sluggish_start',
   ...
   '[{"label":"Worse after overnight","value":"overnight"},{"label":"Same after a few hours","value":"any_sit"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('slow_crank_sluggish_start',
   'How old is the battery — less than 2 years, 2 to 4 years, more than 4 years, or you''re not sure?',
   '[{"label":"Less than 2 years","value":"under_2"},{"label":"2 to 4 years","value":"2_to_4"},{"label":"More than 4 years","value":"over_4"},{"label":"Not sure","value":"unsure"}]',
  ...
  ('slow_crank_sluggish_start',
   ...
   '[{"label":"Dim while cranking, brighten after","value":"dim_then_bright"},{"label":"Normal","value":"normal"},{"label":"Stay dim","value":"stay_dim"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('slow_crank_sluggish_start',
   'After it does start, does it run normally or does it idle rough for the first minute or two?',
   '[{"label":"Runs normally","value":"normal"},{"label":"Idles rough briefly","value":"rough_briefly"},{"label":"Idles rough longer","value":"rough_long"}]',
   7),
  ...
  ('battery_drains_overnight',
   ...
   '[{"label":"Overnight","value":"overnight"},{"label":"A couple of days","value":"days"},{"label":"A week or more","value":"week"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('battery_drains_overnight',
   'Once you jump it or charge it, does the car start and run normally for the rest of the day?',
   '[{"label":"Yes — runs normally","value":"yes"},{"label":"No — still has issues","value":"no"},{"label":"Sometimes","value":"sometimes"}]',
   2),
  ('battery_drains_overnight',
  ...
  ('battery_drains_overnight',
   ...
   '[{"label":"New battery already replaced","value":"replaced"},{"label":"Old battery","value":"old"},{"label":"Newer battery","value":"new"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('battery_drains_overnight',
   'Does it die faster in hot weather, cold weather, or does the weather not seem to matter?',
   '[{"label":"Worse in hot","value":"hot"},{"label":"Worse in cold","value":"cold"},{"label":"Weather doesn''t matter","value":"any"},{"label":"Not sure","value":"unsure"}]',
   7),
  ...
  ('dim_or_flickering_lights',
   ...
   '[{"label":"Dim","value":"dim"},{"label":"Flickering","value":"flicker"},{"label":"Pulsing brighter/dimmer","value":"pulse"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('dim_or_flickering_lights',
  ...
  ('dim_or_flickering_lights',
   ...
   '[{"label":"Normal","value":"normal"},{"label":"Also dim/flicker","value":"affected"},{"label":"Not sure","value":"unsure"}]',
   4),
  ('dim_or_flickering_lights',
  ...
  ('dim_or_flickering_lights',
   ...
   '[{"label":"Started before recent work","value":"before"},{"label":"Started after recent work","value":"after"},{"label":"No recent work","value":"none"},{"label":"Not sure","value":"unsure"}]',
   7),
  ...
  ('an_accessory_doesnt_work',
   ...
   '[{"label":"One window","value":"one_window"},{"label":"All windows","value":"all_windows"},{"label":"Radio","value":"radio"},{"label":"Dome light","value":"dome"},{"label":"Wipers","value":"wipers"},{"label":"Power locks","value":"locks"},{"label":"Something else","value":"other"}]',
   1),
  ('an_accessory_doesnt_work',
  ...
  ('an_accessory_doesnt_work',
   ...
   '[{"label":"All at once","value":"sudden"},{"label":"Acted up first","value":"gradual"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('an_accessory_doesnt_work',
  ...
  ('an_accessory_doesnt_work',
   ...
   '[{"label":"Click","value":"click"},{"label":"Hum","value":"hum"},{"label":"Buzz","value":"buzz"},{"label":"Completely silent","value":"silent"}]',
   5),
  ('an_accessory_doesnt_work',
  ...
  ('an_accessory_doesnt_work',
   ...
   '[{"label":"Found a blown fuse","value":"blown"},{"label":"All looked okay","value":"okay"},{"label":"Haven''t checked","value":"unchecked"}]',
   7),
  ...
  ('multiple_random_electrical_glitches',
   ...
   '[{"label":"Yes — I''ll describe","value":"describe"},{"label":"Not sure exactly","value":"unsure"}]',
   1),
  ('multiple_random_electrical_glitches',
   'Do the glitches happen at the same time as each other, or do different things act up at different times?',
   '[{"label":"Same time","value":"together"},{"label":"Different times","value":"separate"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('multiple_random_electrical_glitches',
   'Is it worse over bumps and rough roads, or does it happen just as much on smooth pavement?',
   '[{"label":"Worse over bumps","value":"bumps"},{"label":"Same on smooth","value":"same"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('multiple_random_electrical_glitches',
  ...
  ('car_died_while_driving_electrical',
   ...
   '[{"label":"Sputtered/gradual","value":"gradual"},{"label":"All at once","value":"sudden"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('car_died_while_driving_electrical',
  ...
  ('car_died_while_driving_electrical',
   ...
   '[{"label":"Starter tried to crank","value":"crank"},{"label":"Nothing at all","value":"silent"},{"label":"Not sure","value":"unsure"}]',
   5),
  ('car_died_while_driving_electrical',
   ...
   '[{"label":"Lot of accessories","value":"many"},{"label":"Few","value":"few"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('car_died_while_driving_electrical',
   'Has the car been jump-started recently, and if so, did this happen during that same drive or a day or two later?',
   '[{"label":"Same drive","value":"same_drive"},{"label":"Day or two later","value":"later"},{"label":"No recent jump","value":"none"},{"label":"Not sure","value":"unsure"}]',
   7)
)
...
-- =====================================================================
-- 2b. HVAC questions (8 subcategories, 56 questions)
-- =====================================================================
...
new_questions(slug, question_text, options_json, display_order) AS (
  ...
  ('ac_blows_warm_or_hot_air',
   ...
   '[{"label":"Warm all the time","value":"always"},{"label":"Cools then warms","value":"degrades"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('ac_blows_warm_or_hot_air',
  ...
  ('ac_blows_warm_or_hot_air',
   ...
   '[{"label":"Yes — better at highway","value":"yes"},{"label":"No — same","value":"no"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('ac_blows_warm_or_hot_air',
  ...
  ('ac_is_weak_not_cold_enough',
   ...
   '[{"label":"Yes — better moving","value":"yes"},{"label":"No — same","value":"no"},{"label":"Not sure","value":"unsure"}]',
   4),
  ('ac_is_weak_not_cold_enough',
  ...
  ('ac_is_weak_not_cold_enough',
   ...
   '[{"label":"Slowly worsened","value":"gradual"},{"label":"All at once","value":"sudden"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('ac_is_weak_not_cold_enough',
  ...
  ('heat_doesnt_work',
   ...
   '[{"label":"Cold","value":"cold"},{"label":"Room temperature","value":"room"},{"label":"A little warm","value":"slight_warm"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('heat_doesnt_work',
   'Does it take a long time of driving before any warm air comes out, or does it never warm up at all?',
   '[{"label":"Takes long time","value":"slow"},{"label":"Never warms up","value":"never"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('heat_doesnt_work',
  ...
  ('heat_doesnt_work',
   ...
   '[{"label":"Same","value":"same"},{"label":"Different","value":"different"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('heat_doesnt_work',
   'Did the heat problem start after the car sat for a while, or after any recent service?',
   '[{"label":"After sitting","value":"sat"},{"label":"After service","value":"service"},{"label":"Neither","value":"neither"},{"label":"Not sure","value":"unsure"}]',
   7),

  -- ── Vents Don't Blow Strongly (7) ──────────────────────────────────
  ('vents_dont_blow_strongly_weak_airflow',
   'Is the air weak on every fan speed, or only on certain speeds (like only working on high)?',
   '[{"label":"Every speed","value":"all"},{"label":"Only on certain speeds","value":"some"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('vents_dont_blow_strongly_weak_airflow',
   'When was the cabin air filter last replaced?',
   '[{"label":"Recently","value":"recent"},{"label":"Long time ago","value":"old"},{"label":"Never","value":"never"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('vents_dont_blow_strongly_weak_airflow',
   'Is the airflow weak from every vent, or only the dash, floor, or defrost?',
   '[{"label":"Every vent","value":"all"},{"label":"Dash only","value":"dash"},{"label":"Floor only","value":"floor"},{"label":"Defrost only","value":"defrost"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('vents_dont_blow_strongly_weak_airflow',
  ...
  ('foggy_or_hard_to_defog_windows',
   ...
   '[{"label":"Only cold/rainy days","value":"weather"},{"label":"All the time","value":"always"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('foggy_or_hard_to_defog_windows',
   'When you turn on defrost, does air actually come out of the vents at the bottom of the windshield?',
   '[{"label":"Yes","value":"yes"},{"label":"No","value":"no"},{"label":"Weak","value":"weak"}]',
   2),
  ('foggy_or_hard_to_defog_windows',
  ...
  ('strange_noise_from_vents',
   ...
   '[{"label":"Only fan on","value":"fan_on"},{"label":"Also fan off","value":"both"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('strange_noise_from_vents',
  ...
  ('strange_noise_from_vents',
   ...
   '[{"label":"Behind dash","value":"dash"},{"label":"Passenger footwell","value":"footwell"},{"label":"Under hood","value":"hood"},{"label":"Not sure","value":"unsure"}]',
   7),
  ...
  ('bad_smell_from_vents',
   ...
   '[{"label":"Musty/moldy","value":"musty"},{"label":"Sweet/maple syrup","value":"sweet"},{"label":"Gasoline","value":"gas"},{"label":"Burning","value":"burning"},{"label":"Something else","value":"other"}]',
   1),
  ('bad_smell_from_vents',
   'Is the smell strongest when you first turn the AC on, or after the AC has been running a while?',
   '[{"label":"When first turning on","value":"first"},{"label":"After running a while","value":"later"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('bad_smell_from_vents',
   'Does the smell happen with the AC on, the heat on, or both?',
   '[{"label":"AC only","value":"ac"},{"label":"Heat only","value":"heat"},{"label":"Both","value":"both"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('bad_smell_from_vents',
  ...
  ('one_zone_works_but_another_doesnt',
   ...
   '[{"label":"Driver","value":"driver"},{"label":"Passenger","value":"passenger"},{"label":"Rear","value":"rear"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('one_zone_works_but_another_doesnt',
   'Is one side blowing cold while the other blows warm, or one warm while the other is cold?',
   '[{"label":"One cold, other warm","value":"cold_warm"},{"label":"One warm, other cold","value":"warm_cold"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('one_zone_works_but_another_doesnt',
  ...
  ('one_zone_works_but_another_doesnt',
   ...
   '[{"label":"Changes","value":"changes"},{"label":"Stays stuck","value":"stuck"},{"label":"Not sure","value":"unsure"}]',
   5),
  ('one_zone_works_but_another_doesnt',
...
-- =====================================================================
-- 2c. LEAK questions (7 subcategories, 49 questions)
-- =====================================================================
...
new_questions(slug, question_text, options_json, display_order) AS (
  ...
  ('brown_or_black_puddle_engine_oil',
   ...
   '[{"label":"Few drops","value":"drops"},{"label":"Saucer-sized","value":"saucer"},{"label":"Wider puddle","value":"large"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('brown_or_black_puddle_engine_oil',
   'Does it only leak after you''ve been driving, or do you see fresh drops even after the car has sat overnight?',
   '[{"label":"Only after driving","value":"after_drive"},{"label":"Also after sitting","value":"any_time"},{"label":"Not sure","value":"unsure"}]',
   7),
  ...
  -- ── Red or Pink Puddle (Transmission/Power Steering) (7) ───────────
  ('red_or_pink_puddle_transmission_or_power_steering',
   ...
   '[{"label":"Middle of car","value":"middle"},{"label":"Front near engine","value":"front"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('red_or_pink_puddle_transmission_or_power_steering',
  ...
  ('red_or_pink_puddle_transmission_or_power_steering',
   ...
   '[{"label":"After driving","value":"after_drive"},{"label":"Also when sitting","value":"any_time"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('red_or_pink_puddle_transmission_or_power_steering',
   'Do you mainly see the spot after the car has been running, or is it there first thing in the morning too?',
   '[{"label":"After running","value":"running"},{"label":"Also morning","value":"morning"},{"label":"Not sure","value":"unsure"}]',
   7),

  -- ── Clear, Yellow, or Light Brown Puddle (Brake Fluid) (7) ─────────
  ('clear_yellow_or_light_brown_brake_fluid',
  ...
  ('clear_yellow_or_light_brown_brake_fluid',
   ...
   '[{"label":"Near a wheel","value":"wheel"},{"label":"Under middle","value":"middle"},{"label":"Engine bay driver''s side","value":"engine_driver"},{"label":"Not sure","value":"unsure"}]',
   5),
  ('clear_yellow_or_light_brown_brake_fluid',
  ...
  ('clear_yellow_or_light_brown_brake_fluid',
   ...
   '[{"label":"Yes — low","value":"low"},{"label":"Looks normal","value":"normal"},{"label":"Haven''t checked","value":"unsure"}]',
   7),

  -- ── Clear, Odorless Puddle (Water / AC Condensation) (7) ───────────
  ...
  ('clear_odorless_puddle_water_or_ac_condensation',
   ...
   '[{"label":"Yes","value":"yes"},{"label":"No — leaves stain","value":"no"},{"label":"Not sure","value":"unsure"}]',
   4),
  ('clear_odorless_puddle_water_or_ac_condensation',
  ...
  ('clear_odorless_puddle_water_or_ac_condensation',
   ...
   '[{"label":"Only after AC","value":"ac_only"},{"label":"Also without AC","value":"either"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('clear_odorless_puddle_water_or_ac_condensation',
  ...
  -- ── Thick Dark Brown (Gear/Differential Oil) (7) ───────────────────
  ...
  ('blue_or_light_blue_puddle_washer_fluid',
   ...
   '[{"label":"Yes — reaches windshield","value":"yes"},{"label":"Weakened","value":"weak"},{"label":"No spray at all","value":"none"}]',
   3),
  ('blue_or_light_blue_puddle_washer_fluid',
  ...
  ('blue_or_light_blue_puddle_washer_fluid',
   ...
   '[{"label":"Only after washer use","value":"after_use"},{"label":"All the time","value":"always"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('blue_or_light_blue_puddle_washer_fluid',
...
-- =====================================================================
-- 2d. NOISE questions (10 subcategories, 70 questions)
-- =====================================================================
...
new_questions(slug, question_text, options_json, display_order) AS (
  ...
  ('engine_ticking_or_tapping',
   ...
   '[{"label":"At key turn","value":"immediate"},{"label":"After a few minutes","value":"delayed"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('engine_ticking_or_tapping',
  ...
  ('engine_ticking_or_tapping',
   ...
   '[{"label":"Top of engine","value":"top"},{"label":"Lower part","value":"lower"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('engine_ticking_or_tapping',
   'When was the last time you had the oil changed?',
   '[{"label":"Recently","value":"recent"},{"label":"A while ago","value":"older"},{"label":"Long overdue","value":"overdue"},{"label":"Not sure","value":"unsure"}]',
   4),
  ('engine_ticking_or_tapping',
  ...
  ('engine_ticking_or_tapping',
   ...
   '[{"label":"Quieter","value":"quieter"},{"label":"Goes away","value":"gone"},{"label":"No change","value":"same"},{"label":"Gets worse","value":"worse"}]',
   6),
  ('engine_ticking_or_tapping',
  ...
  ('clunking_over_bumps',
   ...
   '[{"label":"Every bump","value":"every"},{"label":"Only big bumps","value":"big_only"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('clunking_over_bumps',
  ...
  ('clunking_over_bumps',
   ...
   '[{"label":"One side","value":"one_side"},{"label":"Both sides equally","value":"both"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('clunking_over_bumps',
  ...
  ('humming_or_whirring_at_speed',
   ...
   '[{"label":"One specific wheel","value":"specific"},{"label":"Hard to pin down","value":"unclear"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('humming_or_whirring_at_speed',
   'Does the hum stay the same when you take your foot off the gas and coast?',
   '[{"label":"Yes — same","value":"same"},{"label":"Quieter coasting","value":"quieter"},{"label":"Louder coasting","value":"louder"},{"label":"Not sure","value":"unsure"}]',
   4),
  ('humming_or_whirring_at_speed',
  ...
  ('high_pitched_whining_under_the_hood',
   ...
   '[{"label":"Cold","value":"cold"},{"label":"Warm","value":"warm"},{"label":"All the time","value":"always"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('high_pitched_whining_under_the_hood',
  ...
  ('high_pitched_whining_under_the_hood',
   ...
   '[{"label":"Yes","value":"yes"},{"label":"No — elsewhere","value":"no"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('high_pitched_whining_under_the_hood',
  ...
  ('rattling_underneath_the_car',
   ...
   '[{"label":"Startup","value":"startup"},{"label":"Accelerating","value":"accel"},{"label":"Idle","value":"idle"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('rattling_underneath_the_car',
  ...
  ('rattling_underneath_the_car',
   ...
   '[{"label":"Tinny/rock in can","value":"tinny"},{"label":"Heavy clang","value":"clang"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('rattling_underneath_the_car',
  ...
  ('hissing_noise',
   ...
   '[{"label":"Engine off","value":"off"},{"label":"Only when running","value":"running"},{"label":"Both","value":"both"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('hissing_noise',
  ...
  ('hissing_noise',
   ...
   '[{"label":"Under hood","value":"hood"},{"label":"Underneath car","value":"under"},{"label":"Dashboard area","value":"dash"},{"label":"Not sure","value":"unsure"}]',
   5),
  ('hissing_noise',
   'Does the air conditioning still blow cold, or has it gotten weaker?',
   '[{"label":"Still cold","value":"cold"},{"label":"Weaker","value":"weak"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('hissing_noise',
  ...
  ('popping_or_clicking_when_turning',
   ...
   '[{"label":"Sharp turns only","value":"sharp"},{"label":"Also gentle turns","value":"all"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('popping_or_clicking_when_turning',
   'Is the noise louder when turning one direction versus the other?',
   '[{"label":"Louder left","value":"left"},{"label":"Louder right","value":"right"},{"label":"Same both ways","value":"same"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('popping_or_clicking_when_turning',
  ...
  ('popping_or_clicking_when_turning',
   ...
   '[{"label":"Forward","value":"forward"},{"label":"Reverse","value":"reverse"},{"label":"Both","value":"both"},{"label":"Not sure","value":"unsure"}]',
   4),
  ('popping_or_clicking_when_turning',
  ...
  ('popping_or_clicking_when_turning',
   ...
   '[{"label":"Only during turns","value":"turn_only"},{"label":"Also straight","value":"straight_too"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('popping_or_clicking_when_turning',
  ...
  ('deep_knocking_from_the_engine',
   ...
   '[{"label":"Immediately","value":"immediate"},{"label":"After a few minutes","value":"delayed"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('deep_knocking_from_the_engine',
  ...
  ('deep_knocking_from_the_engine',
   ...
   '[{"label":"Louder","value":"louder"},{"label":"Quieter","value":"quieter"},{"label":"No change","value":"same"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('deep_knocking_from_the_engine',
   'What grade of gasoline have you been using, and does your owner''s manual recommend a higher grade?',
   '[{"label":"Lower than recommended","value":"low_grade"},{"label":"Matches recommended","value":"correct"},{"label":"Not sure","value":"unsure"}]',
   4),
  ('deep_knocking_from_the_engine',
  ...
  ('squeaking_or_creaking_over_bumps',
   ...
   '[{"label":"Cold morning","value":"cold"},{"label":"When warmed up","value":"warm"},{"label":"Same","value":"same"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('squeaking_or_creaking_over_bumps',
   'Does the squeak only happen over bumps, or also when you turn the steering wheel while sitting still?',
   '[{"label":"Only bumps","value":"bumps"},{"label":"Also static turns","value":"turns"},{"label":"Both","value":"both"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('squeaking_or_creaking_over_bumps',
  ...
  ('electrical_buzzing',
   ...
   '[{"label":"Continues after off","value":"continues"},{"label":"Stops with engine","value":"stops"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('electrical_buzzing',
   'Does the sound seem to come from the dashboard, behind the dash, or from under the hood?',
   '[{"label":"Dashboard","value":"dash"},{"label":"Behind dash","value":"behind_dash"},{"label":"Under hood","value":"hood"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('electrical_buzzing',
  ...
  ('electrical_buzzing',
   ...
   '[{"label":"All the time","value":"always"},{"label":"Only certain conditions","value":"conditional"},{"label":"Not sure","value":"unsure"}]',
   7)
)
INSERT INTO public.concern_questions
  (shop_id, category, subcategory_id, question_text, options, display_order, active)
...
-- =====================================================================
-- 2e. OTHER questions (6 subcategories, 42 questions)
-- =====================================================================
...
new_questions(slug, question_text, options_json, display_order) AS (
  VALUES
  -- ── Multiple Symptoms / Not Sure What Category (7) ─────────────────
  ('multiple_symptoms_not_sure_what_category',
   ...
   '[{"label":"One first, then others","value":"sequential"},{"label":"All at the same time","value":"together"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('multiple_symptoms_not_sure_what_category',
   'Are the issues happening together every time, or does each one come and go on its own?',
   '[{"label":"Together every time","value":"together"},{"label":"Come and go separately","value":"independent"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('multiple_symptoms_not_sure_what_category',
  ...
  ('multiple_symptoms_not_sure_what_category',
   ...
   '[{"label":"Yes — pattern","value":"yes"},{"label":"No pattern","value":"no"},{"label":"Not sure","value":"unsure"}]',
   4),
  ('multiple_symptoms_not_sure_what_category',
  ...
  ('after_a_recent_accident_or_impact',
   ...
   '[{"label":"Today — haven''t driven","value":"today_undriven"},{"label":"Today — driven since","value":"today_driven"},{"label":"Days ago","value":"days"},{"label":"Weeks ago","value":"weeks"}]',
   1),
  ('after_a_recent_accident_or_impact',
   'Was it a collision with another vehicle, a curb hit, a pothole, or running over something in the road?',
   '[{"label":"Another vehicle","value":"vehicle"},{"label":"Curb hit","value":"curb"},{"label":"Pothole","value":"pothole"},{"label":"Road debris","value":"debris"},{"label":"Other","value":"other"}]',
   2),
  ('after_a_recent_accident_or_impact',
   'Did any airbags deploy, or did any warning lights come on after the impact?',
   '[{"label":"Airbags deployed","value":"airbags"},{"label":"Warning lights only","value":"lights"},{"label":"Neither","value":"neither"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('after_a_recent_accident_or_impact',
   'Are you filing an insurance claim, or is this something you''re handling on your own?',
   '[{"label":"Insurance claim","value":"insurance"},{"label":"Handling myself","value":"self"},{"label":"Not sure yet","value":"unsure"}]',
   4),
  ('after_a_recent_accident_or_impact',
   'Does the steering feel different — pulling to one side, off-center, or shaky?',
   '[{"label":"Pulling","value":"pulling"},{"label":"Off-center","value":"off_center"},{"label":"Shaky","value":"shaky"},{"label":"Normal","value":"normal"},{"label":"Not sure","value":"unsure"}]',
   5),
  ('after_a_recent_accident_or_impact',
  ...
  ('after_a_recent_accident_or_impact',
   ...
   '[{"label":"Level","value":"level"},{"label":"One corner lower","value":"uneven"},{"label":"Not sure","value":"unsure"}]',
   7),
  ...
  ('after_recent_service_or_repair_work',
   ...
   '[{"label":"Our shop","value":"our_shop"},{"label":"Dealership","value":"dealer"},{"label":"Somewhere else","value":"other_shop"}]',
   1),
  ('after_recent_service_or_repair_work',
   'About how long ago was that service, and do you have the receipt or invoice handy?',
   '[{"label":"Days ago — have receipt","value":"days_receipt"},{"label":"Days ago — no receipt","value":"days_none"},{"label":"Weeks ago","value":"weeks"},{"label":"Months ago","value":"months"}]',
   2),
  ('after_recent_service_or_repair_work',
   'What was the original reason you took it in — and is this the same problem coming back, or something new?',
   '[{"label":"Same problem returning","value":"same"},{"label":"Something new","value":"new"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('after_recent_service_or_repair_work',
   'Did the issue show up right after picking up the car, or did it appear days or weeks later?',
   '[{"label":"Right after pickup","value":"immediate"},{"label":"Days later","value":"days"},{"label":"Weeks later","value":"weeks"},{"label":"Not sure","value":"unsure"}]',
   4),
  ('after_recent_service_or_repair_work',
  ...
  ('after_recent_service_or_repair_work',
   ...
   '[{"label":"Yes — a lot","value":"a_lot"},{"label":"A little","value":"a_little"},{"label":"Barely at all","value":"barely"}]',
   6),
  ('after_recent_service_or_repair_work',
  ...
  -- ── Safety Concern — Don't Feel Safe Driving It (7) ────────────────
  ('safety_concern_dont_feel_safe_driving_it',
   ...
   '[{"label":"Somewhere safe","value":"safe"},{"label":"Stranded","value":"stranded"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('safety_concern_dont_feel_safe_driving_it',
  ...
  ('safety_concern_dont_feel_safe_driving_it',
   ...
   '[{"label":"Working normally","value":"normal"},{"label":"Soft/low","value":"soft"},{"label":"Not stopping well","value":"failing"},{"label":"Not sure","value":"unsure"}]',
   4),
  ('safety_concern_dont_feel_safe_driving_it',
   'Is the steering working normally, or does it feel stiff, loose, or hard to control?',
   '[{"label":"Working normally","value":"normal"},{"label":"Stiff","value":"stiff"},{"label":"Loose","value":"loose"},{"label":"Hard to control","value":"hard_control"}]',
   5),
  ('safety_concern_dont_feel_safe_driving_it',
   'Is there a flashing warning light on the dashboard right now, like a flashing check engine or red temperature light?',
   '[{"label":"Yes — flashing","value":"flashing"},{"label":"Solid light","value":"solid"},{"label":"No lights","value":"none"}]',
   6),
  ('safety_concern_dont_feel_safe_driving_it',
   'Would you feel comfortable driving it slowly to the shop, or would you rather have it towed in?',
   '[{"label":"Drive slowly","value":"drive"},{"label":"Tow it","value":"tow"},{"label":"Not sure","value":"unsure"}]',
   7),

  -- ── General Check-Up or Pre-Trip Inspection (7) ────────────────────
  ('general_checkup_or_pre_trip_inspection',
  ...
  ('general_checkup_or_pre_trip_inspection',
   ...
   '[{"label":"Recently","value":"recent"},{"label":"A while back","value":"awhile"},{"label":"Long time ago","value":"long_ago"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('general_checkup_or_pre_trip_inspection',
  ...
  ('general_checkup_or_pre_trip_inspection',
   ...
   '[{"label":"Under 50k","value":"low"},{"label":"50k-100k","value":"mid"},{"label":"100k-150k","value":"high"},{"label":"Over 150k","value":"very_high"},{"label":"Not sure","value":"unsure"}]',
   4),
  ('general_checkup_or_pre_trip_inspection',
  ...
  ('general_checkup_or_pre_trip_inspection',
   ...
   '[{"label":"Brakes","value":"brakes"},{"label":"Tires","value":"tires"},{"label":"Fluids","value":"fluids"},{"label":"Everything","value":"all"},{"label":"Not sure","value":"unsure"}]',
   6),
  ('general_checkup_or_pre_trip_inspection',
   'Is there a date you need the car ready by?',
   '[{"label":"Yes — specific date","value":"yes"},{"label":"No — flexible","value":"no"},{"label":"ASAP","value":"asap"}]',
   7),

  -- ── Car Has Been Sitting Unused for a Long Time (7) ────────────────
  ('car_has_been_sitting_unused_for_a_long_time',
   'About how long has the car been sitting without being driven?',
   '[{"label":"A few weeks","value":"weeks"},{"label":"Months","value":"months"},{"label":"A year or more","value":"year_plus"},{"label":"Not sure","value":"unsure"}]',
   1),
  ('car_has_been_sitting_unused_for_a_long_time',
   'Was it parked in a garage, under a cover, or outside in the weather?',
   '[{"label":"Garage","value":"garage"},{"label":"Under cover","value":"cover"},{"label":"Outside","value":"outside"},{"label":"Not sure","value":"unsure"}]',
   2),
  ('car_has_been_sitting_unused_for_a_long_time',
   'Did you take any steps before parking it — like adding fuel stabilizer or disconnecting the battery?',
   '[{"label":"Yes — steps taken","value":"yes"},{"label":"No","value":"no"},{"label":"Not sure","value":"unsure"}]',
   3),
  ('car_has_been_sitting_unused_for_a_long_time',
   'Have you tried to start it recently, and if so, did it start up or struggle?',
   '[{"label":"Started up","value":"started"},{"label":"Struggled","value":"struggled"},{"label":"Won''t start","value":"no_start"},{"label":"Haven''t tried","value":"not_tried"}]',
   4),
  ('car_has_been_sitting_unused_for_a_long_time',
   'Is the car a hybrid or electric vehicle?',
   '[{"label":"Hybrid","value":"hybrid"},{"label":"Electric","value":"ev"},{"label":"Gas","value":"gas"},{"label":"Diesel","value":"diesel"},{"label":"Not sure","value":"unsure"}]',
   5),
  ('car_has_been_sitting_unused_for_a_long_time',
  ...
  ('car_has_been_sitting_unused_for_a_long_time',
   ...
   '[{"label":"Tow truck","value":"tow"},{"label":"Drive it in","value":"drive"},{"label":"Not sure","value":"unsure"}]',
   7)
)
INSERT INTO public.concern_questions
  (shop_id, category, subcategory_id, question_text, options, display_order, active)
...
-- SECTION_2F_PERFORMANCE_PLACEHOLDER

-- SECTION_2G_PULLING_PLACEHOLDER

-- SECTION_2H_SMELL_PLACEHOLDER

-- SECTION_2I_SMOKE_PLACEHOLDER

-- SECTION_2J_STEERING_PLACEHOLDER

-- SECTION_2K_TIRES_PLACEHOLDER

-- SECTION_2L_VIBRATION_PLACEHOLDER

-- SECTION_2M_WARNING_LIGHT_PLACEHOLDER

-- SECTION_3_SANITY_CHECK_PLACEHOLDER
